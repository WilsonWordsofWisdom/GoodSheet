...
import { classifyStoolImage, loadImageFromFile } from "../stool-classifier";
import type { ClassificationResult } from "../stool-classifier";
import {
  classifyFoodImage,
  loadFoodImageFromFile,
  preloadFoodClassifier,
} from "../food-classifier";
import type { FoodClassificationResult, FoodClassifyStatus } from "../food-classifier";
